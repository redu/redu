...
describe "Walls" do
  let(:ned) do
    Factory(:user, :first_name => 'Ned', :last_name => 'Stark', :login => 'ned_stark')
  end
  let(:cercei) do
    Factory(:user, :first_name => 'Cercei', :last_name => 'Lannister', :login => 'cercei_lannister')
  end

  before do
    # To view walls
    ActiveRecord::Observer.with_observers(:status_observer,
                                          :log_observer,
                                          :friendship_observer,
                                          :user_observer,
                                          :log_observer) do
