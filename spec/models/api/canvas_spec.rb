...
describe Api::Canvas do
  ...
  context "validations" do
    subject do
      Api::Canvas.create(:client_application => FactoryBot.create(:client_application))
    end
