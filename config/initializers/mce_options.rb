...
AppConfig.question_mce_options = {
  ...
  :editor_deselector => "mceNoEditor",
  :theme_advanced_resize_horizontal => false,  
  :theme_advanced_buttons1 => %w{bold italic underline separator bullist numlist separator link unlink image asciimath asciimathcharmap asciisvg},
  :theme_advanced_buttons2 => [],
  :theme_advanced_buttons3 => [],
    #:relative_urls => false,
  #:convert_urls => false,
  :plugins => %w{safari,asciimath,asciisvg,table,inlinepopups},
