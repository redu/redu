...
AppConfig.question_mce_options = {
  ...
  :theme_advanced_buttons2 => [],
  :theme_advanced_buttons3 => [],
  :plugins => %w{media curblyadvimage safari autosave asciimath asciisvg table inlinepopups},
  #:plugin_preview_pageurl => '../../../../../posts/preview',
  #:plugin_preview_width => "950",
  #:plugin_preview_height => "650",
  :editor_deselector => "mceNoEditor",
...
=begin
  ...
  :plugins => %w{safari asciimath asciisvg table inlinepopups media preview curblyadvimage},
=end
