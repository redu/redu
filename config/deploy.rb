...
role :web,      "ec2-184-73-99-85.compute-1.amazonaws.com"
role :app,      "ec2-184-73-99-85.compute-1.amazonaws.com"
role :memcache, "ec2-184-73-99-85.compute-1.amazonaws.com"
role :db,       "ec2-184-73-99-85.compute-1.amazonaws.com", :primary => true
...
set :ec2onrails_config, {
  ...
  :mysql_root_password => "sociallearning",
  
  # Any extra Ubuntu packages to install if desired
  # If you don't want to install extra packages then remove this.
  :packages => ["logwatch", "ffmpeg", "librmagick-ruby1.8", "ghostscript", "imagemagick", "libmagick9-dev", "libmysqlclient15-dev"],
  ...
  :rubygems => ["rails -v 2.3.5", "desert", "packet", "chronic", "haml", "hpricot", "htmlentities", "rmagick", "brcobranca", "rghost", "rghost_barcode", "calendar_date_select", "icalendar", "will_paginate -v 2.3.11", "adzap-ar_mailer", "parseline", "htmlentities", "mysql", "tiny_mce"],
  ...
  :service_domain => "ec2-184-73-99-85.compute-1.amazonaws.com",
  ...
  # remove this.
  :mail_forward_address => "redu@redu.com.br",
