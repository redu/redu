...
module Redu
  class Application < Rails::Application
    ...
    config.assets.precompile += %w(new_application.js friend-invitation.js basic.js landing.js mobile.js status_show.js bootstrap-affix.js lectures.js exercise-questions.js folders.js entity-management-members-filter.js)
    config.assets.precompile += %w(bootstrap-redu.min.css new_application.css basic.css mobile.css authoring-page.css)
    config.assets.precompile += %w(maintenance.css chart.css)
